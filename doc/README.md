...
-   [Intro](#intro-1){#toc-intro-1}
-   [Intro](#intro-2){#toc-intro-2}
...
-   [Documentation of each
    ...
    -   [./bin/asci_plot.sh.txt {#binasci_plotshtxt}
        {#binasci_plotshtxt-binasci_plotshtxt}](#binasci_plotshtxt-binasci_plotshtxt-binasci_plotshtxt-binasci_plotshtxt){#toc-binasci_plotshtxt-binasci_plotshtxt-binasci_plotshtxt-binasci_plotshtxt}
    -   [./bin/basic_plot.sh.txt {#binbasic_plotshtxt}
        {#binbasic_plotshtxt-binbasic_plotshtxt}](#binbasic_plotshtxt-binbasic_plotshtxt-binbasic_plotshtxt-binbasic_plotshtxt){#toc-binbasic_plotshtxt-binbasic_plotshtxt-binbasic_plotshtxt-binbasic_plotshtxt}
    -   [./bin/clock.sh.txt {#binclockshtxt}
        {#binclockshtxt-binclockshtxt}](#binclockshtxt-binclockshtxt-binclockshtxt-binclockshtxt){#toc-binclockshtxt-binclockshtxt-binclockshtxt-binclockshtxt}
    -   [./bin/launch_lurker.sh.txt {#binlaunch_lurkershtxt}
        {#binlaunch_lurkershtxt-binlaunch_lurkershtxt}](#binlaunch_lurkershtxt-binlaunch_lurkershtxt-binlaunch_lurkershtxt-binlaunch_lurkershtxt){#toc-binlaunch_lurkershtxt-binlaunch_lurkershtxt-binlaunch_lurkershtxt-binlaunch_lurkershtxt}
    -   [./bin/launch_writer.sh.txt {#binlaunch_writershtxt}
        {#binlaunch_writershtxt-binlaunch_writershtxt}](#binlaunch_writershtxt-binlaunch_writershtxt-binlaunch_writershtxt-binlaunch_writershtxt){#toc-binlaunch_writershtxt-binlaunch_writershtxt-binlaunch_writershtxt-binlaunch_writershtxt}
    -   [./bin/lurker.sh.txt {#binlurkershtxt}
        {#binlurkershtxt-binlurkershtxt}](#binlurkershtxt-binlurkershtxt-binlurkershtxt-binlurkershtxt){#toc-binlurkershtxt-binlurkershtxt-binlurkershtxt-binlurkershtxt}
    -   [./bin/mkhtml.sh.txt {#binmkhtmlshtxt}
        {#binmkhtmlshtxt-binmkhtmlshtxt}](#binmkhtmlshtxt-binmkhtmlshtxt-binmkhtmlshtxt-binmkhtmlshtxt){#toc-binmkhtmlshtxt-binmkhtmlshtxt-binmkhtmlshtxt-binmkhtmlshtxt}
    -   [./bin/plot_histo_g.sh.txt {#binplot_histo_gshtxt}
        {#binplot_histo_gshtxt-binplot_histo_gshtxt}](#binplot_histo_gshtxt-binplot_histo_gshtxt-binplot_histo_gshtxt-binplot_histo_gshtxt){#toc-binplot_histo_gshtxt-binplot_histo_gshtxt-binplot_histo_gshtxt-binplot_histo_gshtxt}
    -   [./bin/plot_histo.sh.txt {#binplot_histoshtxt}
        {#binplot_histoshtxt-binplot_histoshtxt}](#binplot_histoshtxt-binplot_histoshtxt-binplot_histoshtxt-binplot_histoshtxt){#toc-binplot_histoshtxt-binplot_histoshtxt-binplot_histoshtxt-binplot_histoshtxt}
    -   [./bin/plot_rrd2.sh.txt {#binplot_rrd2shtxt}
        {#binplot_rrd2shtxt-binplot_rrd2shtxt}](#binplot_rrd2shtxt-binplot_rrd2shtxt-binplot_rrd2shtxt-binplot_rrd2shtxt){#toc-binplot_rrd2shtxt-binplot_rrd2shtxt-binplot_rrd2shtxt-binplot_rrd2shtxt}
    -   [./bin/writer.sh.txt {#binwritershtxt}
        {#binwritershtxt-binwritershtxt}](#binwritershtxt-binwritershtxt-binwritershtxt-binwritershtxt){#toc-binwritershtxt-binwritershtxt-binwritershtxt-binwritershtxt}
    -   [./mkdoc.sh.txt {#mkdocshtxt}
        {#mkdocshtxt-mkdocshtxt}](#mkdocshtxt-mkdocshtxt-mkdocshtxt-mkdocshtxt){#toc-mkdocshtxt-mkdocshtxt-mkdocshtxt-mkdocshtxt}
    -   [./plugin/cpu.txt {#plugincputxt}
        {#plugincputxt-plugincputxt}](#plugincputxt-plugincputxt-plugincputxt-plugincputxt){#toc-plugincputxt-plugincputxt-plugincputxt-plugincputxt}
    -   [./plugin/ibm_acpi_fan.txt {#pluginibm_acpi_fantxt}
        {#pluginibm_acpi_fantxt-pluginibm_acpi_fantxt}](#pluginibm_acpi_fantxt-pluginibm_acpi_fantxt-pluginibm_acpi_fantxt-pluginibm_acpi_fantxt){#toc-pluginibm_acpi_fantxt-pluginibm_acpi_fantxt-pluginibm_acpi_fantxt-pluginibm_acpi_fantxt}
    -   [./plugin/ibm_acpi.txt {#pluginibm_acpitxt}
        {#pluginibm_acpitxt-pluginibm_acpitxt}](#pluginibm_acpitxt-pluginibm_acpitxt-pluginibm_acpitxt-pluginibm_acpitxt){#toc-pluginibm_acpitxt-pluginibm_acpitxt-pluginibm_acpitxt-pluginibm_acpitxt}
    -   [./plugin/irq.txt {#pluginirqtxt}
        {#pluginirqtxt-pluginirqtxt}](#pluginirqtxt-pluginirqtxt-pluginirqtxt-pluginirqtxt){#toc-pluginirqtxt-pluginirqtxt-pluginirqtxt-pluginirqtxt}
    -   [./plugin/open_files.txt {#pluginopen_filestxt}
        {#pluginopen_filestxt-pluginopen_filestxt}](#pluginopen_filestxt-pluginopen_filestxt-pluginopen_filestxt-pluginopen_filestxt){#toc-pluginopen_filestxt-pluginopen_filestxt-pluginopen_filestxt-pluginopen_filestxt}
    -   [./plugin/processes.txt {#pluginprocessestxt}
        {#pluginprocessestxt-pluginprocessestxt}](#pluginprocessestxt-pluginprocessestxt-pluginprocessestxt-pluginprocessestxt){#toc-pluginprocessestxt-pluginprocessestxt-pluginprocessestxt-pluginprocessestxt}
    -   [./plugin/stat.txt {#pluginstattxt}
        {#pluginstattxt-pluginstattxt}](#pluginstattxt-pluginstattxt-pluginstattxt-pluginstattxt){#toc-pluginstattxt-pluginstattxt-pluginstattxt-pluginstattxt}
    -   [./plugin/tcp.txt {#plugintcptxt}
        {#plugintcptxt-plugintcptxt}](#plugintcptxt-plugintcptxt-plugintcptxt-plugintcptxt){#toc-plugintcptxt-plugintcptxt-plugintcptxt-plugintcptxt}
    -   [./pubsub.sh.txt {#pubsubshtxt}
        {#pubsubshtxt-pubsubshtxt}](#pubsubshtxt-pubsubshtxt-pubsubshtxt-pubsubshtxt){#toc-pubsubshtxt-pubsubshtxt-pubsubshtxt-pubsubshtxt}
    -   [./start.sh.txt {#startshtxt}
        {#startshtxt-startshtxt}](#startshtxt-startshtxt-startshtxt-startshtxt){#toc-startshtxt-startshtxt-startshtxt-startshtxt}
    -   [./stop.sh.txt {#stopshtxt}
        {#stopshtxt-stopshtxt}](#stopshtxt-stopshtxt-stopshtxt-stopshtxt){#toc-stopshtxt-stopshtxt-stopshtxt-stopshtxt}
-   [Quickstart](#quickstart-1){#toc-quickstart-1}
    -   [Requirements](#requirements-1){#toc-requirements-1}
    -   [Starting the
        probe](#starting-the-probe-1){#toc-starting-the-probe-1}
    -   [Starting the collect of
        data](#starting-the-collect-of-data-1){#toc-starting-the-collect-of-data-1}
-   [State Machine of the
    system](#state-machine-of-the-system-1){#toc-state-machine-of-the-system-1}
-   [Agent Oriented
    Programming](#agent-oriented-programming-1){#toc-agent-oriented-programming-1}
-   [Documentation of each
    scripts](#documentation-of-each-scripts-1){#toc-documentation-of-each-scripts-1}
    -   [./bin/asci_plot.sh.txt
        {#binasci_plotshtxt}](#binasci_plotshtxt-binasci_plotshtxt){#toc-binasci_plotshtxt-binasci_plotshtxt}
    -   [./bin/basic_plot.sh.txt
        {#binbasic_plotshtxt}](#binbasic_plotshtxt-binbasic_plotshtxt){#toc-binbasic_plotshtxt-binbasic_plotshtxt}
    -   [./bin/clock.sh.txt
        {#binclockshtxt}](#binclockshtxt-binclockshtxt){#toc-binclockshtxt-binclockshtxt}
    -   [./bin/launch_lurker.sh.txt
        {#binlaunch_lurkershtxt}](#binlaunch_lurkershtxt-binlaunch_lurkershtxt){#toc-binlaunch_lurkershtxt-binlaunch_lurkershtxt}
    -   [./bin/launch_writer.sh.txt
        {#binlaunch_writershtxt}](#binlaunch_writershtxt-binlaunch_writershtxt){#toc-binlaunch_writershtxt-binlaunch_writershtxt}
    -   [./bin/lurker.sh.txt
        {#binlurkershtxt}](#binlurkershtxt-binlurkershtxt){#toc-binlurkershtxt-binlurkershtxt}
    -   [./bin/mkhtml.sh.txt
        {#binmkhtmlshtxt}](#binmkhtmlshtxt-binmkhtmlshtxt){#toc-binmkhtmlshtxt-binmkhtmlshtxt}
    -   [./bin/plot_histo_g.sh.txt
        {#binplot_histo_gshtxt}](#binplot_histo_gshtxt-binplot_histo_gshtxt){#toc-binplot_histo_gshtxt-binplot_histo_gshtxt}
    -   [./bin/plot_histo.sh.txt
        {#binplot_histoshtxt}](#binplot_histoshtxt-binplot_histoshtxt){#toc-binplot_histoshtxt-binplot_histoshtxt}
    -   [./bin/plot_rrd2.sh.txt
        {#binplot_rrd2shtxt}](#binplot_rrd2shtxt-binplot_rrd2shtxt){#toc-binplot_rrd2shtxt-binplot_rrd2shtxt}
    -   [./bin/writer.sh.txt
        {#binwritershtxt}](#binwritershtxt-binwritershtxt){#toc-binwritershtxt-binwritershtxt}
    -   [./mkdoc.sh.txt
        {#mkdocshtxt}](#mkdocshtxt-mkdocshtxt){#toc-mkdocshtxt-mkdocshtxt}
    -   [./plugin/cpu.txt
        {#plugincputxt}](#plugincputxt-plugincputxt){#toc-plugincputxt-plugincputxt}
    -   [./plugin/ibm_acpi_fan.txt
        {#pluginibm_acpi_fantxt}](#pluginibm_acpi_fantxt-pluginibm_acpi_fantxt){#toc-pluginibm_acpi_fantxt-pluginibm_acpi_fantxt}
    -   [./plugin/ibm_acpi.txt
        {#pluginibm_acpitxt}](#pluginibm_acpitxt-pluginibm_acpitxt){#toc-pluginibm_acpitxt-pluginibm_acpitxt}
    -   [./plugin/irq.txt
        {#pluginirqtxt}](#pluginirqtxt-pluginirqtxt){#toc-pluginirqtxt-pluginirqtxt}
    -   [./plugin/open_files.txt
        {#pluginopen_filestxt}](#pluginopen_filestxt-pluginopen_filestxt){#toc-pluginopen_filestxt-pluginopen_filestxt}
    -   [./plugin/processes.txt
        {#pluginprocessestxt}](#pluginprocessestxt-pluginprocessestxt){#toc-pluginprocessestxt-pluginprocessestxt}
    -   [./plugin/stat.txt
        {#pluginstattxt}](#pluginstattxt-pluginstattxt){#toc-pluginstattxt-pluginstattxt}
    -   [./plugin/tcp.txt
        {#plugintcptxt}](#plugintcptxt-plugintcptxt){#toc-plugintcptxt-plugintcptxt}
    -   [./pubsub.sh.txt
        {#pubsubshtxt}](#pubsubshtxt-pubsubshtxt){#toc-pubsubshtxt-pubsubshtxt}
    -   [./start.sh.txt
        {#startshtxt}](#startshtxt-startshtxt){#toc-startshtxt-startshtxt}
    -   [./stop.sh.txt
        {#stopshtxt}](#stopshtxt-stopshtxt){#toc-stopshtxt-stopshtxt}
-   [Quickstart](#quickstart-2){#toc-quickstart-2}
    -   [Requirements](#requirements-2){#toc-requirements-2}
    -   [Starting the
        probe](#starting-the-probe-2){#toc-starting-the-probe-2}
    -   [Starting the collect of
        data](#starting-the-collect-of-data-2){#toc-starting-the-collect-of-data-2}
-   [CAVEAT](#caveat){#toc-caveat}
    -   [FreeBSD jails](#freebsd-jails){#toc-freebsd-jails}
    -   [Qemu](#qemu){#toc-qemu}
-   [State Machine of the
    system](#state-machine-of-the-system-2){#toc-state-machine-of-the-system-2}
-   [Agent Oriented
    Programming](#agent-oriented-programming-2){#toc-agent-oriented-programming-2}
-   [Documentation of each
    scripts](#documentation-of-each-scripts-2){#toc-documentation-of-each-scripts-2}
...
## ./bin/asci_plot.sh.txt {#binasci_plotshtxt} {#binasci_plotshtxt-binasci_plotshtxt} {#binasci_plotshtxt-binasci_plotshtxt-binasci_plotshtxt-binasci_plotshtxt}

## ./bin/basic_plot.sh.txt {#binbasic_plotshtxt} {#binbasic_plotshtxt-binbasic_plotshtxt} {#binbasic_plotshtxt-binbasic_plotshtxt-binbasic_plotshtxt-binbasic_plotshtxt}

## ./bin/clock.sh.txt {#binclockshtxt} {#binclockshtxt-binclockshtxt} {#binclockshtxt-binclockshtxt-binclockshtxt-binclockshtxt}

## ./bin/launch_lurker.sh.txt {#binlaunch_lurkershtxt} {#binlaunch_lurkershtxt-binlaunch_lurkershtxt} {#binlaunch_lurkershtxt-binlaunch_lurkershtxt-binlaunch_lurkershtxt-binlaunch_lurkershtxt}
...
## ./bin/launch_writer.sh.txt {#binlaunch_writershtxt} {#binlaunch_writershtxt-binlaunch_writershtxt} {#binlaunch_writershtxt-binlaunch_writershtxt-binlaunch_writershtxt-binlaunch_writershtxt}
...
## ./bin/lurker.sh.txt {#binlurkershtxt} {#binlurkershtxt-binlurkershtxt} {#binlurkershtxt-binlurkershtxt-binlurkershtxt-binlurkershtxt}
...
## ./bin/mkhtml.sh.txt {#binmkhtmlshtxt} {#binmkhtmlshtxt-binmkhtmlshtxt} {#binmkhtmlshtxt-binmkhtmlshtxt-binmkhtmlshtxt-binmkhtmlshtxt}
...
## ./bin/plot_histo_g.sh.txt {#binplot_histo_gshtxt} {#binplot_histo_gshtxt-binplot_histo_gshtxt} {#binplot_histo_gshtxt-binplot_histo_gshtxt-binplot_histo_gshtxt-binplot_histo_gshtxt}

## ./bin/plot_histo.sh.txt {#binplot_histoshtxt} {#binplot_histoshtxt-binplot_histoshtxt} {#binplot_histoshtxt-binplot_histoshtxt-binplot_histoshtxt-binplot_histoshtxt}

## ./bin/plot_rrd2.sh.txt {#binplot_rrd2shtxt} {#binplot_rrd2shtxt-binplot_rrd2shtxt} {#binplot_rrd2shtxt-binplot_rrd2shtxt-binplot_rrd2shtxt-binplot_rrd2shtxt}

## ./bin/writer.sh.txt {#binwritershtxt} {#binwritershtxt-binwritershtxt} {#binwritershtxt-binwritershtxt-binwritershtxt-binwritershtxt}
...
## ./mkdoc.sh.txt {#mkdocshtxt} {#mkdocshtxt-mkdocshtxt} {#mkdocshtxt-mkdocshtxt-mkdocshtxt-mkdocshtxt}
...
## ./plugin/cpu.txt {#plugincputxt} {#plugincputxt-plugincputxt} {#plugincputxt-plugincputxt-plugincputxt-plugincputxt}

## ./plugin/ibm_acpi_fan.txt {#pluginibm_acpi_fantxt} {#pluginibm_acpi_fantxt-pluginibm_acpi_fantxt} {#pluginibm_acpi_fantxt-pluginibm_acpi_fantxt-pluginibm_acpi_fantxt-pluginibm_acpi_fantxt}
...
## ./plugin/ibm_acpi.txt {#pluginibm_acpitxt} {#pluginibm_acpitxt-pluginibm_acpitxt} {#pluginibm_acpitxt-pluginibm_acpitxt-pluginibm_acpitxt-pluginibm_acpitxt}
...
## ./plugin/irq.txt {#pluginirqtxt} {#pluginirqtxt-pluginirqtxt} {#pluginirqtxt-pluginirqtxt-pluginirqtxt-pluginirqtxt}
...
## ./plugin/open_files.txt {#pluginopen_filestxt} {#pluginopen_filestxt-pluginopen_filestxt} {#pluginopen_filestxt-pluginopen_filestxt-pluginopen_filestxt-pluginopen_filestxt}
...
## ./plugin/processes.txt {#pluginprocessestxt} {#pluginprocessestxt-pluginprocessestxt} {#pluginprocessestxt-pluginprocessestxt-pluginprocessestxt-pluginprocessestxt}
...
## ./plugin/stat.txt {#pluginstattxt} {#pluginstattxt-pluginstattxt} {#pluginstattxt-pluginstattxt-pluginstattxt-pluginstattxt}
...
## ./plugin/tcp.txt {#plugintcptxt} {#plugintcptxt-plugintcptxt} {#plugintcptxt-plugintcptxt-plugintcptxt-plugintcptxt}

NAME tcp - Plugin to monitor IPV4/6 TCP socket status on a Linux host.

LICENSE GPLv2

## ./pubsub.sh.txt {#pubsubshtxt} {#pubsubshtxt-pubsubshtxt} {#pubsubshtxt-pubsubshtxt-pubsubshtxt-pubsubshtxt}

## ./start.sh.txt {#startshtxt} {#startshtxt-startshtxt} {#startshtxt-startshtxt-startshtxt-startshtxt}
...
## ./stop.sh.txt {#stopshtxt} {#stopshtxt-stopshtxt} {#stopshtxt-stopshtxt-stopshtxt-stopshtxt}
...
## ./plugin/cpu.txt {#plugincputxt} {#plugincputxt-plugincputxt}
...
In order for freebsd Jails to access UDP broadcast, you need to setup [a
VNET
